            ...
            <div class="col-12">
             <div class="card">
              <div class="card-header">
                <h3 class="card-title">Verifikasi Surat Keterangan Drop Out Mahasiswa</h3>
              </div>
              <div class="card-body">
                <table id="example2" class="table table-striped table-bordered table-hover">
                 ...
                 <tbody>
                  <?php
                  $i=1;
                  $sqlGet = "SELECT * FROM v_sk WHERE status='0' ";
                  ...
                  <td>
                   <center>
                    <a href="function.php?id_sk=<?php echo $data["id_sk"]; ?>" 
