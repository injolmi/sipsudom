              ...
              <div class="card-body">
                <table id="example1" class="table table-striped table-bordered table-hover">
                 ...
                 <tbody>
                  <?php
                  $i=1;
                  $sqlGet = "SELECT * FROM v_sp WHERE status='1'";
                  ...
                  while($data = mysqli_fetch_array($query)){
                   ...
                   <tr>
                    ...
                    <td>
                     <center>
                      <a href="function2.php?id_sp=<?php echo $data["id_sp"]; ?>" 
                        onclick="return confirm('Apakah anda yakin akan melakukan verifikasi?');" class="btn btn-success"><i class="fas fa-check-circle"></i>Teruskan ke BAAK</a> ||
