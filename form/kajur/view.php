            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <tbody>
                <?php
                $i=1;
                if ($_SESSION['jabatan']=="Ketua Jurusan TI") {
                  $sqlGet = "SELECT * FROM v_sp where  id_jurusan='5' ";
                  $query = mysqli_query($koneksi, $sqlGet);
                }elseif ($_SESSION['jabatan']=="Ketua Jurusan TE") {
                  $sqlGet = "SELECT * FROM v_sp where  id_jurusan='7'";
                  $query = mysqli_query($koneksi, $sqlGet);
                }elseif ($_SESSION['jabatan']=="Ketua Jurusan TM") {
                  $sqlGet = "SELECT * FROM v_sp where  id_jurusan='8'";
                  $query = mysqli_query($koneksi, $sqlGet);
                }elseif ($_SESSION['jabatan']=="Koordinator TL") {
                 $sqlGet = "SELECT * FROM v_sp where  id_jurusan='9'";
                 $query = mysqli_query($koneksi, $sqlGet);
               }elseif ($_SESSION['jabatan']=="Koordinator TPPL") {
                $sqlGet = "SELECT * FROM v_sp where  id_jurusan='10' ";
                $query = mysqli_query($koneksi, $sqlGet);
              }elseif ($_SESSION['jabatan']=="Koordinator PPA") {
               $sqlGet = "SELECT * FROM v_sp where  id_jurusan='11' ";
               $query = mysqli_query($koneksi, $sqlGet);
             }else{
                    ...
                    <form method="" action="">
                      <div class="form-group">
                        <ul class="list-group list-group-unbordered mb-3">
                          ...
                          <li class="list-group-item">
                            <b>Surat Pemanggilan Orang Tua</b> <a class="float-right" href="../dokumen/<?php echo $data ['surat_pemanggilan_ortu'] ?>"><img src="../../pdf.png" width="100" height="50"></a>
                          </li>
                          <li class="list-group-item">
                            <b>Berita Acara</b><a class="float-right" href="../dokumen/<?php echo $data ['berita_acara'] ?>"><img src="../../pdf.png" width="100" height="50"></a>
                          </li>
